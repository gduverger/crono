...
def post_job(job: Job):
	# print(job['trigger']['seconds'])
	# print(job['task']['type'])
	# print(job['task']['parameters'])
...
routes = [
	Route('/', 'GET', welcome),
	Route('/beta/jobs', 'GET', get_jobs),
	Route('/beta/jobs/', 'GET', get_jobs, name='get_jobs_slash'),
	Route('/beta/jobs', 'POST', post_job),
	Route('/beta/jobs/', 'POST', post_job, name='post_job_slash'),
	Route('/beta/jobs/{job_id}', 'GET', get_job),
	Route('/beta/jobs/{job_id}/', 'GET', get_job, name='get_job_slash'),
	Route('/beta/jobs/{job_id}', 'DELETE', delete_job),
	Route('/beta/jobs/{job_id}/', 'DELETE', delete_job, name='delete_job_slash'),
