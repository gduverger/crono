...
if __name__ == '__main__':
	...
	server = ThreadedServer(SchedulerService, hostname=os.getenv('RPYC_SERVER_HOSTNAME', 'localhost'), port=int(os.getenv('PORT', 12345)), protocol_config=protocol_config)
